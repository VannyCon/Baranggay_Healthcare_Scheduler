...
if (isset($_GET['Hid']) && isset($_GET['Pid'])) {
    ...
    if ($patientInfo && $historyInfo) {
        ...
        $sectionStyle = [
            'orientation' => 'portrait', // Portrait mode (default for A4)
            'pageSizeW'   => \PhpOffice\PhpWord\Shared\Converter::inchToTwip(8.27), // A4 width in inches (converted to Twips)
            'pageSizeH'   => \PhpOffice\PhpWord\Shared\Converter::inchToTwip(11.69), // A4 height in inches
            'marginTop'    => \PhpOffice\PhpWord\Shared\Converter::inchToTwip(0.5), // 1 inch top margin
            'marginBottom' => \PhpOffice\PhpWord\Shared\Converter::inchToTwip(0.5), // 1 inch bottom margin
            'marginLeft'   => \PhpOffice\PhpWord\Shared\Converter::inchToTwip(0.5), // 1 inch left margin
            'marginRight'  => \PhpOffice\PhpWord\Shared\Converter::inchToTwip(0.5), // 1 inch right margin
        ];

        // Add the section with A4 dimensions
